		...
		<div class="uk-margin">
			...
			>
				<li class="uk-open">
					...
					<div class="uk-accordion-content uk-accordion-content sc-border sc-round sc-padding">
						...
						<table v-if="isScholarship(data)" class="table-word-break-all uk-table-detail uk-table uk-table-responsive uk-table-divider uk-text-pre-table">
							<tbody>
						...
						<table v-else-if="isIntership(data)" class="table-word-break-all uk-table-detail uk-table uk-table-responsive uk-table-divider">
							<tbody>
						...
						<table v-else-if="isPractice(data)" class="table-word-break-all uk-table-detail uk-table uk-table-responsive uk-table-divider">
							<tbody>
						...
						<table v-else-if="isInfo(data)" class="table-word-break-all uk-table-detail uk-table uk-table-responsive uk-table-divider">
							<tbody>

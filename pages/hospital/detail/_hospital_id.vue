					...
					<ScCardBody>
						<form class="uk-form-horizontal">
									...
									<table class="uk-table-detail uk-table uk-table-responsive uk-table-divider">
										<tbody>
											...
											<tr>
												...
												<td>
													{{ hospital_dt.organization_name_kana }}
												</td>
											</tr>
											<tr>
												<th class="uk-width-medium">
									...
									<table class="uk-table-detail uk-table uk-table-responsive uk-table-divider">
										<tbody>
											<tr>
												...
												<td>
													{{ hospital_dt.hospital_type | view('hospital_type') }}
												</td>
											</tr>
										</tbody>
									</table>
							...
							<div class="uk-margin-large-top uk-text-center">
								<nuxt-link :to="`/hospital/edit/${$route.params.hospital_id}`">
...
export default {
	...
	async asyncData ( {app, params, error} ) {
		let { data } = await app.$axios.get(`/api/hospital/${params.hospital_id}`)
			.catch((e) =>  {
			})
		return { hospital_dt: data }
	},
}
</script>
